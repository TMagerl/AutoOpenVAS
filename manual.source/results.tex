...
\hint If you do not use any monitoring solution or scripts you can skip this part. Simply visit the OpenVAS web interface to get results (see\toimg{integration_active}).
